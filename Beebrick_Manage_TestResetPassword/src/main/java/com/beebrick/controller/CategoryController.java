...
public class CategoryController {
	 ...
	 * @RequestMapping(value = "admin/category/update", method = RequestMethod.POST)
	 * public String update(@Valid Category category, BindingResult bindingResult,
	 * Model model, String categoryName) { List<Category> list =
	 * categoryService.findByName(categoryName); if(!list.isEmpty()) {
	 * category.setCategoryName(null); model.addAttribute("message",
	 * "Category Name is already exists!"); return "admin/category/add"; } if
	 * (bindingResult.hasErrors()) { return "admin/category/edit"; } else {
	 * categoryService.save(category); return "redirect:/admin/category"; } }
	 */
